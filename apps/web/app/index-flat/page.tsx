...
export default function IndexFlat() {
  ...
  return (
    <div style={{ height: "100vh", overflowY: "auto", overflowX: "hidden", scrollbarGutter: "stable", background: "#D6EEFF", fontFamily: "var(--font-inter,'Inter'),sans-serif" }}>
      ...
      <header style={{
        ...
        padding: "0 clamp(24px,6vw,80px)", height: "72px",
      ...
      {/* ── ROUTE : démarre dès le top (pin 01 visible au-dessus de l'input)
          La search bar est overlayée à calc(11.25vw + 220px) depuis le haut de section,
          soit ~220px en dessous du pin 01 (y=90 SVG = 11.25vw réels).
          hideStepCards masque les cards texte — la search bar EST l'étape 01.         */}
      <div style={{ position: "relative" }}>
        <TutorialRoute hideHeader />

        {/* Titre + search bar flottants, bien en dessous du pin 01 */}
        <div style={{
          position: "absolute",
